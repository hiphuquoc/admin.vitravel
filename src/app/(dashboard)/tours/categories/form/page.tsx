...
function CategoryFormInner() {
  ...
  const detailQueryKey = useScopedQueryKey('tour-category', id, locale);

  const detailQuery = useQuery({
    queryKey: detailQueryKey,
    queryFn: createScopedQueryFn(() => categoriesApi.get(id!, locale)),
    enabled: !!id,
  ...
  const save = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      await qc.invalidateQueries({ queryKey: [projectCode, 'tour-categories'] });
